          ...
          <TableBody>
            {filtered.map((qso) => (
              ...
              >
                ...
                <TableCell className="font-mono font-semibold text-[var(--accent-text)]">
                  {qso.callsign}
                </TableCell>
                ...
                <TableCell className="font-mono text-[var(--text-secondary)]">{formatFreq(qso.frequencyHz)}</TableCell>
                <TableCell className="font-mono">{qso.rstSent}</TableCell>
                <TableCell className="font-mono">{qso.rstReceived}</TableCell>
                <TableCell className="text-[var(--text-secondary)]">{qso.name || ''}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
